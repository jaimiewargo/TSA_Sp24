...
#Have to use print function to see ggplot with for loop
#1+i is to access the column for each hydropower plant, first column is the date
```
...
ggplot(df_detrend, aes(x=date))+
  geom_line(aes(y=observed), color='darkblue')+
