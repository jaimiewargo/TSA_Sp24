...
model1 <- meanf(ts_electricity_price[,1], h=12)
summary(model1)
plot(model1)
...
model3 <- snaive(ts_electricity_price[,1], h=12)
summary(model3)
plot(model3)
...
model6 <- sma(ts_electricity_price[,1], h=12)

autoplot(ts_electricity_price[,1], series='Original')+
...
autoplot(deseasonal_allsectors_price, series='deseasonal')+
  autolayer(model7$mean, series='SES')

# Model 8:  Simple exponential smoothing on original data
model8 <- ses(ts_electricity_price[,1], h=12)

autoplot(ts_electricity_price[,1], series='Original')+
  autolayer(model8$mean, series='SES')
...
model9 <- auto.arima(ts_electricity_price[,1])
