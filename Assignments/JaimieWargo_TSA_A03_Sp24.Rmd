...
bm_acfplot <- autoplot(Acf(energy_ts[,1], lag.max=40, main="Biomass ACF"))
                       
bm_pacfplot <- autoplot(Pacf(energy_ts[,1], lag.max=40, main="Biomass PACF"))
...
hp_acfplot <- autoplot(Acf(energy_ts[,3], lag.max=40, main="Hydropower ACF"))
                       
hp_pacfplot <- autoplot(Pacf(energy_ts[,3], lag.max=40, main="Hydropower PACF"))
...
tre_acfplot <- autoplot(Acf(energy_ts[,2], lag.max=40, 
                           main="Renewable Energy ACF"))
                       
tre_pacfplot <- autoplot(Pacf(energy_ts[,2], lag.max=40, 
                             main="Renewable Energy PACF"))
